...
| **Actor Principal**                 | Administrador                                                                                      |
| **Actores Secundarios**             | -                                                                                                  |
| **Breve descripción**               | El Administrador puede realizar filtros por criterio de usuarios que utilizan el sitema. (*CU-02*) |
| **Precondiciones**                  | 1. El usuario, a filtrar, debe estar dado de alta y activo.                                        |
...
| **Precondiciones**                  | 1. El modelo de instrumento, a filtrar, debe estar dado de alta y activa. (*CU-04*)                           |
| **Flujo Principal**                 | 1. El actor selecta las opciones para configurar el filtro.                                                   |
|                                     | 2. El actor ejecuta el filtro.                                                                                |
| **Flujos Alternativos/Excepciones** | -                                                                                                             |
| **Postcondiciones**                 | El filtro queda realizado y se muestra el resultado.                                                          |
...
| **Precondiciones**                  | 1. La unidad de medida, a filtrar, debe estar dada de alta y activa. (*CU-06*)                         |
| **Flujo Principal**                 | 1. El actor selecta las opciones para configurar el filtro.                                            |
|                                     | 2. El actor ejecuta el filtro.                                                                         |
| **Flujos Alternativos/Excepciones** | -                                                                                                      |
| **Postcondiciones**                 | El filtro queda realizado y se muestra el resultado.                                                   |
...
| **Precondiciones**                  | 1. El rango de medición, a filtrar, debe estar dado de alta y activo. (*CU-08*)                           |
| **Flujo Principal**                 | 1. El actor selecta las opciones para configurar el filtro.                                               |
|                                     | 2. El actor ejecuta el filtro.                                                                            |
| **Flujos Alternativos/Excepciones** | -                                                                                                         |
| **Postcondiciones**                 | El filtro queda realizado y se muestra el resultado.                                                      |
...
| **Precondiciones**                  | 1. El destino, a filtrar, debe estar dado de alta y activo. (*CU-09*)                           |
| **Flujo Principal**                 | 1. El actor selecta las opciones para configurar el filtro.                                     |
|                                     | 2. El actor ejecuta el filtro.                                                                  |
| **Flujos Alternativos/Excepciones** | -                                                                                               |
| **Postcondiciones**                 | El filtro queda realizado y se muestra el resultado.                                            |
...
| Campo                               | Descripción                                                                                                                        |
| ----------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| **Nombre del Caso de Uso**          | Realizar ABM de instrumentos                                                                                                       |
| **Actor Principal**                 | Administrador                                                                                                                      |
| **Actores Secundarios**             | -                                                                                                                                  |
| **Breve descripción**               | El Administrador puede realizar las acciones: dar de alta, modificar y/o baja de los instrumentos que se utilizarán en el sistema. |
| **Precondiciones**                  | 1. Rol Administrador activo.                                                                                                       |
...
| Campo                               | Descripción                                                                                         |
| ----------------------------------- | --------------------------------------------------------------------------------------------------- |
| **Nombre del Caso de Uso**          | Filtrar instrumentos                                                                                |
| **Actor Principal**                 | Administrador                                                                                       |
| **Actores Secundarios**             | -                                                                                                   |
| **Precondiciones**                  | 1. El instrumento, a filtrar, debe estar dado de alta y activo. (*CU-11*)                           |
...
| Campo                               | Descripción                                                                                                                         |
| ----------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
| **Nombre del Caso de Uso**          | Dar alta instrumento recibido                                                                                                       |
| **Actor Principal**                 | Administrador                                                                                                                       |
| **Actores Secundarios**             | -                                                                                                                                   |
| **Precondiciones**                  | 1. El instrumento debe estar dado de alta en el sistema. (*CU-10*)                                                                  |
| **Breve descripción**               | El Administrador puede realizar la acción: dar de alta el instrumento recibido que se procesará en el sistema para su trazabilidad. |
| **Flujo Principal**                 | 1. El actor selecciona los datos correspondientes al instrumento a registrar.                                                       |
|                                     | 2. El actor guarda los cambios.                                                                                                     |
| **Flujos Alternativos/Excepciones** | 2a. El actor puede cancelar.                                                                                                        |
| **Postcondiciones**                 | Queda realizada la acción de dar alta al instrumento recibido.                                                                      |
...
| **Precondiciones**                  | 1. El instrumento recibido debe estar dado de alta. (*CU-13*)                                                         |
| **Breve descripción**               | El Administrador puede realizar filtros por criterio de instrumentos recibidos que se dieron de alta en el sistema.   |
| **Flujo Principal**                 | 1. El actor selecta las opciones para configurar el filtro.                                                           |
|                                     | 2. El actor ejecuta el filtro.                                                                                        |
| **Flujos Alternativos/Excepciones** | `extend`: *Generar reporte de instrumento recibido*: es posible generar un reporte de instrumento recibido. (*CU-20*) |
| **Postcondiciones**                 | El filtro queda realizado y se muestra el resultado.                                                                  |
...
|                                     | `extend`: *Generar reporte planilla de calibración*: es posible generar un reporte de planilla de calibración. (*CU-21*) |
...
| **Actor Principal**                 | Administrador                                                                                                           |
| **Actores Secundarios**             | -                                                                                                                       |
| **Precondiciones**                  | 1. Planilla de calibración debe estar creada. (*CU-15*)                                                                 |
...
| **Flujos Alternativos/Excepciones** | `include`: *Crear planilla de calibración:* para consultar la planilla de calibración.                                  |
|                                     | `extend`: *Generar reporte planilla de calibración:* es posible generar un reporte de planilla de clibración. (*CU-21*) |
...
| **Actor Principal**                 | Administrador                                                                                                               |
| **Actores Secundarios**             | -                                                                                                                           |
| **Precondiciones**                  | 1. El historial debe estar creado por el sistema. (*CU-Sistema*)                                                            |
...
|                                     | 2. El actor ingresa el dato requerido para la búsqueda.                                                                     |
|                                     | 3. El actor ejecuta la búsqueda.                                                                                            |
| **Flujos Alternativos/Excepciones** | 1. `extend`: *Generar reporte historial de instrumento*: es posible generar un reporte de planilla de clibración. (*CU-22*) |
...
## Especificación de caso de uso: CU-20 (*extend de CU-14* )
...
## Especificación de caso de uso: CU-21 (*extend de CU-15 o CU-16*)
...
| **Actores Secundarios**             | -                                                                                 |
| **Breve descripción**               | El administrador tiene la opción de realizar un reporte del instrumento recibido. |
| **Precondiciones**                  | 1. La planillla de calibración debe estar generada.                               |
| **Flujo Principal**                 | 1. El actor selecciona la opción de "Generar reporte".                            |
| **Flujos Alternativos/Excepciones** | -                                                                                 |
| **Postcondiciones**                 | El reporte queda generado.                                                        |

## Especificación de caso de uso: CU-22 (*extend de CU-17*)
...
| **Precondiciones**                  | 1. La consulta del historial debe realizarse primero.(*CU-17*)                                              |
|                                     | 2. Para la realización de la consulta es necesario que el sistema haya generado el historial (*CU-Sistema*) |
| **Flujo Principal**                 | 1. El actor selecciona la opción de "Generar reporte".                                                      |
| **Flujos Alternativos/Excepciones** | -                                                                                                           |
| **Postcondiciones**                 | El reporte queda generado.                                                                                  |
...
## Especificación de caso de uso: CU-24 (*CU-Sistema*)
...
## Especificación de caso de uso: CU-25 (*CU-Sistema*)
...
| **Precondiciones**                  | 1. El usuario, para registrar logs, debe estar dado de alta y activo. |
| **Flujo Principal**                 | 1. Es llamado desde el CU-01: *Cerrar sesión*.                        |
|                                     | 2. Realiza la acción automatizada.                                    |
| **Flujos Alternativos/Excepciones** | -                                                                     |
| **Postcondiciones**                 | El registro de cierre de sesión queda realizado.                      |

## Especificación de caso de uso: CU-26 (*CU-Sistema*)
...
## Especificación de caso de uso: CU-27 (*CU-Sistema*)
